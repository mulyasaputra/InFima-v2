...
const ActivitysDoughnut = document.getElementById("ActivitysDoughnut"),
      WSavingDoughnut = document.getElementById("w-savings"),
      WSalaryDoughnut = document.getElementById("w-salary");
 ...
 var myChartDoughnut2 = new Chart(WSavingDoughnut, {
   type: "doughnut",
   data: {
      labels: labels,
      datasets: [{
         data: DoughnutWSaving,
         backgroundColor: colors,
      }, ],
   },
   options: {
 ...
 var myChartDoughnut2 = new Chart(WSalaryDoughnut, {
   type: "doughnut",
   data: {
      labels: labels,
      datasets: [{
         data: DoughnutWSalary,
         backgroundColor: colors,
      }, ],
   },
   options: {
