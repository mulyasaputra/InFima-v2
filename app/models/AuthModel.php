   ...
   public function register($data)
   {
      ...
      if ($this->db->rowCount() == 0) {
         if ($data['password'] === $data['password2']) {
            ...
            $query = "INSERT INTO " . $this->table . " VALUES ('', '', :username, :email, :password, :date)";
            ...
            $query1 = "INSERT INTO profile VALUES ('', :user_id, :api_key, :user, 'default.jpg', :lokasi, '', :account)";
            ...
            $query2 = "INSERT INTO print_out VALUES ('', :user_id, :type, :margin, :margin_units, :size, :size_units)";
